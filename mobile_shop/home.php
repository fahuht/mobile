	...
	<div class="container">
        ...
        <div class="row">
        	<div id="main" class="col-lg-12 col-md-12 col-sm-12">
                    ...
                    <div class="product-list row">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 mx-product">
                            ...
                            <a href="product-detail.php?prd_id=<?php echo $prdFeatured['prd_id']; ?>"><img src="images/product/<?php echo $prdFeatured['prd_image']; ?>"></a>
                                ...
                                <p>Price: <span><?php echo number_format($prdFeatured['prd_price'],0,'.',',');?>đ</span></p>
                            </div>
                        </div>
                ...
                <!--	Latest Product	-->
                <?php 
                    $sqlNewProduct = "SELECT * FROM product WHERE prd_new = 1 ORDER BY prd_id  DESC LIMIT 6";
                    ...
                    <div class="product-list row">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 mx-product">
                            <div class="product-item card text-center">
                                ...
                                <p>Giá Bán: <span><?php echo number_format($prdNew['prd_price'],0,'.',','); ?>đ</span></p>
                            </div>
                        </div>
                        <?php     
