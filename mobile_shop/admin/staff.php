...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li><a href="staff.php" style="background-color:#c21515"><svg class="glyph stroked male user "><use xlink:href="#stroked-male-user"/></svg>Quản lý thành viên</a></li>
                        ...
                        <table 
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="form-group">
                                        <a href="thanhvien-edit.html" class="btn btn-warning"><i class="glyphicon glyphicon-pencil"></i></a>
                                        <a href="/" class="btn btn-danger"><i class="glyphicon glyphicon-remove"></i></a>
                                    </td>
                                </tr>
                                <tr>
                                        <td style="">2</td>
                                        <td style="">Nguyễn Thu Hà</td>
                                        <td style="">nguyenthuha@gmail.com</td>
